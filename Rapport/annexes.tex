...
\caption{Galaxie spirale\label{fig15}}
\end{minipage}
\end{figure}
...
\caption{2 galaxies\label{fig16}}
\end{minipage} \hfill
\begin{minipage}[b]{.46\linewidth}
\centering\epsfig{figure=./images/BH_tree.png,width=\linewidth}
\caption{Quadtree\label{fig17}}
\end{minipage}
\end{figure}

...
\captionsetup{hypcap=false}
\captionof{figure}{Bilan énergétique méthode naïve \\($\Delta t = 50$ ans et $1000$ itérations)}
\label{fig4}
\end{center} 
...
\captionsetup{hypcap=false}
\captionof{figure}{Bilan énergétique méthode naïve optimisée \\($\Delta t = 50$ ans et $1000$ itérations)}
\label{fig5}
\end{center} 

...
public:
 ...
 ~BHTreeNode();
  ...
  Vec2D CalcNaiveForce(const ParticleData &p1, PODState *pState, PODAuxState *m_pAux, int p_num,int pos) const;
  Vec2D CalcNaiveForceefficient(const ParticleData &p1, PODState *pState, PODAuxState *m_pAux,int p_num,int pos,double *acx,double *acy) const;

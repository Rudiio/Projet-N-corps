...
###Séquentiel
plt.figure(figsize=(8,5))
plt.plot(BH_seq[0:taille,0],BH_seq[0:taille,1],"+-",label="BH")
plt.plot(NO_seq[:,0],NO_seq[:,1],"+-",label="NO")
...
###Parallèle
plt.figure(figsize=(8,5))
plt.plot(BH_par[0:taille,0],BH_par[0:taille,1],"+-",label="BH")
plt.plot(NO_par[:,0],NO_par[:,1],"+-",label="NO")
...
#Naïve optimisée
plt.figure(figsize=(8,5))
plt.plot(NO_seq[:,0],NO_seq[:,1],"+-",label="seq")
